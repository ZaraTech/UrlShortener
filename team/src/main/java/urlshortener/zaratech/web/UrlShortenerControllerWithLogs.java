...
public class UrlShortenerControllerWithLogs {
    ...
    public ResponseEntity<ShortURL> singleShortener(@RequestParam("url") String url, 
    		...
    		@RequestParam(value = "vCardCheckbox", required = false) Boolean vCardCheckbox, HttpServletRequest request) {
        logger.info("Requested new short for uri " + url);

        return UploadManager.singleShort(shortURLRepository, url, request, vCardFName, vCardCheckbox);
    }
